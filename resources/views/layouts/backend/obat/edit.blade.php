                                                ...
                                                <div class="m-t-20">
                                                        <form action="{{route('obat.update',$obat->id)}}" method="post">
                                                            ...
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                <div class="col-md-10">
                                                                    <label for="first_name1" class="col-form-label">Nama Obat</label>
                                                                </div>
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                    <input type="text" class="form-control" id="first_name1" name="nm_obat" required="" value="{{$obat->nm_obat}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                    <div class="col-md-10">
                                                                        <label for="first_name1" class="col-form-label">Harga</label>
                                                                    </div>
                                                                    <div class="col-lg-10">
                                                                        <div class="input-group">
                                                                            <input type="" class="form-control" id="first_name1" name="harga" required="" value="{{$obat->harga}}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <br>
