                                                ...
                                                <div class="m-t-20">
                                                        <form method="POST" action="{{route('rm.store')}}">
                                                            ...
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                <div class="col-md-10">
                                                                  <label class="col-form-label">Kode Pasien</label>
                                                                </div>
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                    <input type="text" name="kode_pasien" class="form-control" value="P0-<?php echo rand()?>" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                             <br>
                                                             ...
                                                             <div class="control-group input-group" style="margin-top:10px">
                                                                <div class="col-md-10">
                                                                  <label class="col-form-label">Kode resep</label>
                                                                </div>
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                    <input type="text" name="kode_resep" class="form-control" value="RS-<?php echo rand()?>" readonly>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                             <br>
                                                            ...
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                        <input type="text" class="form-control" name="nm_pasienn" required="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            ...
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                        <input type="number" class="form-control" name="usiaa" required="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                        <input type="text" class="form-control" name="alamatt" required="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <label>
                                                            ...
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                    <div class="col-md-10">
                                                                      <label for="first_name1" class="col-form-label">Diagnosa</label>
                                                                    </div>
                                                                    <div class="col-lg-10">
                                                                        <div class="input-group">
                                                                            <input type="" class="form-control" name="diagnosa" required="">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <br>
                                                            ...
                                                            <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <select class="form-control" name="id_obat" multiple>
                                                            ...
                                                            <div class="control-group input-group">
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                        <button style="margin-top:15px" type="submit" name="submit" class="btn btn-primary layout_btn_prevent">Simpan</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
