					...
					<div class="panel-body">
						<div class="canvas-wrapper">
                                <div class="col-md-12">
                                        ...
                                        <center><a href="{{url('/admin/rm/create')}}" class="btn btn-primary">Tambah Data</a></td><br><br></center>
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{$data->kode_resep}}</td>
                                                            <td>{{$data->nm_pasienn}}</td>
                                                            <td>{{$data->jkk}}</td>
                                                            <td>{{$data->usiaa}}</td>
                                                            <td>{{$data->alamatt}}</td>
                                                            <td>{{$data->diagnosa}}</td>
                                                    ...
                                                    <td>
                                                            <form action="{{route('rm.destroy', $data->id)}}" method="post">
                                                                    {{csrf_field()}}
                                                                        <a href="{{route('rm.edit',$data->id)}}"
                                                                            class="btn btn-success btn-sm edit-rm"><i class="fa fa-pencil"></i></a>
