						...
						<div class="canvas-wrapper">
                                <div class="col-md-12">
                                        ...
                                        <!-- <table class="table table-default"> -->
                                                <div class="m-t-20">
                                                        <form method="POST" action="{{route('perawatan.store')}}">
                                                            @csrf
                                                    <label for="fname">Kode Perawatan</label><br>
                                                    <input type="text" id="fname" name="kd_perawatan" class="form-control" value="R-<?php echo rand()?>" readonly><br>
                                                    <label for="fname">Nama Perawatan</label><br>
                                                    <input type="text" id="fname" name="nama_perawatan" class="form-control" value=""><br>
                                                    <label for="lname">Harga</label><br>
                                                    <input type="text" id="lname" name="harga_perawatan" class="form-check-label"value=""><br><br>
