					...
					<div class="panel-body">
						<div class="canvas-wrapper">
                                <div class="col-md-12">
                                        ...
                                        <center><a href="{{url('/admin/perawatan/create')}}" class="btn btn-primary">Tambah Data</a></td><br><br></center>
                                           ...
                                           <thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                        ...
                                                        <tr>
                                                            <td>{{$no++}}</td>
                                                            <td>{{$data->kd_perawatan}}</td>
                                                            <td>{{$data->nama_perawatan}}</td>
                                                            <td>{{$data->harga_perawatan}}</td>


                                                    <td>
                                                            <form action="{{route('perawatan.destroy', $data->id)}}" method="post">
                                                                    {{csrf_field()}}
                                                                    <a href="{{route('perawatan.edit',$data->id)}}"
                                                                            class="btn btn-success btn-sm edit-perawatan"><i class="fa fa-pencil"></i></a>
                                                                        <input type="hidden" name="_method" value="DELETE">
                                                                        <button type="submit " class="btn btn-danger btn-sm hapus-restora"><i class="fa fa-trash"></i></button>
                                                                     </td>
                                                                    </tr>
                                                                </form>
                                                            @endforeach
