        ...
        <ul class="nav menu">
                ...
                <li class=""><a href="{{('rm')}}"><em class="fa fa-">&nbsp;</em>Kasir</a></li>
                            <li class="parent "><a data-toggle="collapse" href="#sub-item-3">
                               ...
                               <li><a class="" href="{{('/admin/persalinann')}}">
                                                ...
                                                <div class="m-t-20">
                                                        <form action="{{route('pasien.update',$pasien->id)}}" method="post">
                                                            ...
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                    <input type="text" class="form-control" id="first_name1" name="nm_pasien" required="" value="{{$pasien->nm_pasien}}" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                        <input type="number" class="form-control" id="first_name1" name="usia" required="" value="{{$pasien->usia}}" >
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                    <input type="text" class="form-control" id="first_name1" name="alamat" required="" value="{{$pasien->alamat}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br>
                                                            ...
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                    ...
                                                                    <div class="col-lg-10">
                                                                        <div class="input-group">
                                                                            <input type="" class="form-control" id="first_name1" name="no_tlpn" required="" value="{{$pasien->no_tlpn}}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <br>
                                                            ...
                                                            <div class="control-group input-group" style="margin-top:10px">
                                                                ...
                                                                <div class="col-lg-10">
                                                                    <div class="input-group">
                                                                        <input type="text" class="form-control" name="ket" value="{{$pasien->ket}}">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <br>
