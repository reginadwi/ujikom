                        ...
                        <div class="panel-body">
                            <div class="canvas-wrapper">
                                    <div class="col-md-12">
                                            ...
                                            <center><a href="{{url('/admin/hamil/create')}}" class="btn btn-primary">Tambah Data</a></td><br><br></center>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @endphp
                                                            ...
                                                            <tr>
                                                                    ...
                                                                    <td>{{$data->id_obat}}</td>
                                                            <td>
                                                                <form action="{{route('hamil.destroy', $data->id)}}" method="post">
                                                                    {{csrf_field()}}

                                                                    <a href="{{route('hamil.edit',$data->id)}}"
                                                                            class="btn btn-success btn-sm edit-pasien"><i class="fa fa-pencil"></i></a>
