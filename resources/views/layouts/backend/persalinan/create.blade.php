                                        ...
                                        <div class="control-group input-group" style="margin-top:10px">
                                            ...
                                            <form class="was-validated">
                                                <div class="mb-3">
                                                  ...
                                                  <textarea class="form-control is-invalid" id="validationTextarea" name="alamatt" required></textarea>
                                                ...
                                                <div class="control-group input-group" style="margin-top:10px">
                                                    <div class="control-group input-group" style="margin-top:10px">
                                                        <div class="col-md-10">
                                                          <label class="col-form-label">Paritas</label>
                                                        </div>
                                                        <div class="col-lg-10">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" name="paritas" required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <br>
                                                    <div class="control-group input-group" style="margin-top:10px">
                                                        <div class="control-group input-group" style="margin-top:10px">
                                                            <div class="col-md-10">
                                                              <label class="col-form-label">HPHT/TP</label>
                                                            </div>
                                                            <div class="col-lg-10">
                                                                <div class="input-group">
                                                                ...
                                                                <div class="control-group input-group" style="margin-top:10px">
                                                                    ...
                                                                    <div class="control-group input-group" style="margin-top:10px">
                                                                        <div class="control-group input-group" style="margin-top:10px">
                                                                            ...
                                                                            <div class="col-lg-10">
                                                                                <div class="input-group">
                                                                                    <input type="text" class="form-control" name="kettt" required="">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <br>
