                        ...
                        <div class="panel-body">
                            <div class="canvas-wrapper">
                                    <div class="col-md-12">
                                            ...
                                            <center><a href="{{url('/admin/persalinan/create')}}" class="btn btn-primary">Tambah Data</a></td><br><br></center>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <form action="{{route('obat.destroy', $data->id)}}" method="post">
                                                                    ...
                                                                    <a href="{{route('obat.edit',$data->id)}}"
                                                                            class="btn btn-success btn-sm edit-obat"><i class="fa fa-pencil"></i></a>
